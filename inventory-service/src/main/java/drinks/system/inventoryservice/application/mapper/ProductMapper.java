...
public class ProductMapper {
    public Product toDomain(ProductEntity e) {
        return new Product(e.getId(), e.getCode(), e.getName(), e.getCategoryId(), e.getSize(),
                e.getDescription(), e.getCostPrice(), e.getSalePrice(), e.getTracksInventory(),
                e.getIsActive(), e.getDeletedAt(), e.getCreatedAt(), e.getUpdatedAt(),
    ...
    public ProductEntity toEntity(Product d) {
        ...
        e.setSalePrice(d.salePrice()); e.setTracksInventory(d.tracksInventory());
        e.setIsActive(d.isActive()); e.setDeletedAt(d.deletedAt());
    ...
    public ProductResponse toResponse(Product p) {
        return new ProductResponse(p.id(), p.code(), p.name(), p.categoryId(), p.size(),
                p.description(), p.costPrice(), p.salePrice(), p.tracksInventory(),
