...
public class CategoryMapper {
    public Category toDomain(CategoryEntity e) {
        return new Category(e.getId(), e.getName(), e.getDescription(), e.getParentCategoryId(),
    ...
    public CategoryEntity toEntity(Category d) {
        ...
        e.setId(d.id()); e.setName(d.name()); e.setDescription(d.description());
    ...
    public CategoryResponse toResponse(Category c) {
        return new CategoryResponse(c.id(), c.name(), c.description(), c.parentCategoryId(),
